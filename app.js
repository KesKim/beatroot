...
var GameSeries = function() {
    ...
    this.games = [
        ...
        new GameThrow(franceThrowSfx, franceHitSfx, new Vec2(320, 160), franceDialog, franceMusic, 'Decadence', 'bottle.png', 'bg-bohemian.png', 'thrown.png', 82, 366, 'bottlethrow.png', 'bird.png', 500, 300, 300, false, 0.20, 0.00015, 9, 0.2),
