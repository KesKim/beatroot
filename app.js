...
var GameSeries = function() {
    ...
    this.games = [
        ...
        new GameThrow(franceThrowSfx, franceHitSfx, new Vec2(320, 160), franceDialog, franceMusic, 'Decadence', 'bottle.png', 'bg-bohemian.png', 'thrown.png', 82, 366, 'bottlethrow.png', 'lizard.png', 500, 530, 430, true, 0.20, 0.00015, 9, 0.2),
        new GameWank('Ignition', 5000, jungleDialog, ['jungle.ogg'], 'bg-jungle.png', 'firethingy.png', new Vec2(320, 160), 140, 0, ['woodrub.ogg']),
        new GameThrow(ancientThrowSfx, ancientHitSfx, new Vec2(320, 160), ancientDialog, ancientMusic, 'Self Confidence', 'spear.png','bg-ancient.png','thrown.png', 47, 366, 'spearthrow.png','bird.png', -100, 600, 70, true, 0.45, 0.0004, 15, 0.3),
        new Game(endDialog)
    ];
